        ...
        <div className="fixed bottom-0 w-full bg-white shadow-lg z-50">
            <div className="flex flex-row items-center justify-around py-2">
                <Link href="/" passHref legacyBehavior>
                    <a className="flex flex-col items-center w-1/3 text-gray-600 hover:text-blue-500">
                ...
                <a
                    className="flex flex-col items-center w-1/3 text-gray-600 hover:text-blue-500"
